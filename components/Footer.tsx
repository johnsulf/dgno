export default function Footer() {
  ...
  return (
    <footer>
      ...
      <div className="prov" style={{ borderTop: "none", paddingTop: 10 }}>
        <b>Datagrunnlag.</b> Aggregert fra PDGAs player-statistics (country=NO,
        alle divisjoner): antall turneringer summert per spiller per år på tvers
        av divisjoner (MPO, FPO, MA1–MA4, masters, junior osv.), 1990–2025.
        «Sesonger» = antall år med minst én turnering. De tidlige årene er reelt
        tynne; første registrerte norske resultat er fra 1990.
      </div>
      <div className="prov" style={{ borderTop: "none", paddingTop: 10 }}>
